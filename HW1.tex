...
\begin{enumerate}[label=\arabic*.]
    ...
    \begin{enumerate}[label=(\alph*)]
        \item Let $\mathbf{d}=(d_1,d_2,\dots, d_n)$ be a non-increasing sequence of non-negative integers, and denote the sequence $(d_2-1, d_3-1,\dots,d_{d_1+1}-1,d_{d_1+2},\dots, d_n)$ by $\mathbf{d}'$. Show that, $\mathbf{d}$ is graphic if and only if $\mathbf{d}'$ is graphic.
        \item Explain any changes you made as a result of the peer review process. Your explanation should clearly state what was wrong with your rough draft and what changes you made. \href{https://docs.google.com/document/d/1jSw9pmMJJFUx_6dTkcUi4k4HJNIrrIIgs9zdWhAycx0/edit?usp=sharing}{See the grading criteria} for Peer Review for reflection examples and templates.
    \end{enumerate}
